...
d. Create a database named kodekloud_db9 and create a database user named kodekloud_pop identified as password 8FmzjvFU6S. Further make sure this newly created user is able to perform all operation on the database you created.
